...
```{r, eval=T, echo=F, tidy=TRUE, code_folding="Mostrar Código"}
...
```{r, eval=T, echo=F, tidy=TRUE, code_folding="Mostrar Código", include=F}
...
O [Desafio 3](Desafios/Desafio_3_v4.html) teste a sua capacidade de juntar bancos de dados e gerar gráficos apropriados e claros.
