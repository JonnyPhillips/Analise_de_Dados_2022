...
<div class = "purple">
O prazo para entregar Desafio 3 por email com título “[FLS6397] - D3” à minha conta é **23/06/2022**. Por favor entregue (i) o arquivo .Rmd, e (ii) o arquivo .html.
</div>

<br>

[Respostas Sugeridas para Desafio 3 aqui](Desafio_3_v6_Suggested_Responses.html)
...
(c) Como uma forma alternativa de apresentar os dados, divida o seu gráfico de histograma em 'facets' (quadros) diferentes, dividido por gênero e raça.
...
candidatos_idade_genero_media_votos %>%
  ...
  ggtitle("Porcentagem de Votos de Candidatos por Idade e Gênero") +
  xlab("Idade") +
  ylab("Média de Porcentagem de Votos") + 
  theme_classic()
```
...
(f) Ajuste o seu gráfico na questão (e) para que o tamanho de cada ponto mostra o total de votos que o PMDB recebeu no município.
...
(g) Ajuste o seu gráfico na questão (e) para que a cor dos pontos (em vez do tamanho) mostre o total de votos que o PMDB recebeu no município. Aplique uma escala de cores apropriada de    sua escolha.
