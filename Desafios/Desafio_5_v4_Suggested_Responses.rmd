...
# obs: As duas últimas linhas na planilha contém dados de resumo que não são observações: o total do estado e o link do site do IBGE de onde a planilha foi tirada. Idealmente, devemos tirar elas, mas por sorte provavalmente eles estarão tirados no momento do left_join na próxima questão. 
```
